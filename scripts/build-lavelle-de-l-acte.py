...
CHAPTER_DIR = Path('src/louis-lavelle/de-l-acte')
OUTPUT_FILE = Path('src/louis-lavelle/de-l-acte.md')
LOCAL_SOURCE_DIR = Path('local-books/louis-lavelle/de-l-acte/fr')

SITE_BASE = 'https://skepvox.com'
BOOK_PATH = '/louis-lavelle/de-l-acte'
BOOK_TITLE = "De l'acte"
AUTHOR = 'Louis Lavelle'
LANGUAGE = 'fr'
DESCRIPTION = (
    "Texte intégral en français de De l'acte de Louis Lavelle, "
    "deuxième volume de La Dialectique de l'éternel présent."
)
IMAGE_URL = (
