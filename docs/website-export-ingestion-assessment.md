...
| **`source`** | `"website-committed"` | `"pipeline-segmented"` | Website docs anticipate a future `source:"pipeline-export"` record (`docs/book-pipeline-website-export-contract-assessment.md:429,458`). |
