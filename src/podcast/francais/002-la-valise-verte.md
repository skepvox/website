...
Le déplacement fonctionne par contraste : on prend un mot administratif sérieux et on l'utilise pour un objet ordinaire. La phrase reste courte et sèche, et la fin garde son effet. On peut faire le même type de plaisanterie avec d'autres objets : un ordinateur "en pause déjeuner", une chaise "en mission", ou une imprimante "en grève". Ce n'est pas une expression fixe à mémoriser. C'est un jeu de registre : le vocabulaire du travail entre dans une situation matérielle.
