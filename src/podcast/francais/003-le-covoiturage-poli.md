...
**se tutoyer** : Se tutoyer, c'est utiliser « tu » entre deux personnes. On peut tutoyer quelqu'un, vouvoyer quelqu'un, ou décider ensemble : "on se tutoie". Dans "on se tutoie", la relation va dans les deux sens : chacun utilise « tu » avec l'autre. C'est fréquent entre amis, dans la famille, entre jeunes, ou dans certains contextes très informels. Exemple : L'application dit : "Ici, on se tutoie."
...
**en retard** : Être en retard signifie ne pas être à l'heure. On peut être en retard pour un train, un cours, un rendez-vous ou un trajet. Le contraire est être en avance. Quand on arrive au bon moment, on est à l'heure. Exemple : Léa dit qu'ils sont déjà un peu en retard.
...
**un inspecteur / une inspectrice** : Un inspecteur observe, contrôle ou vérifie quelque chose. Le mot peut être sérieux, administratif ou professionnel. Avoir un air d'inspecteur, c'est donner cette impression sans l'être forcément. Dans le dialogue, Léa remarque que Thomas a un air d'inspecteur. Exemple : L'inspecteur vérifie la qualité du service.
...
**On se tutoie** est une expression très utile pour parler de la relation entre deux personnes. Elle signifie que les personnes utilisent « tu » entre elles. La forme "se tutoyer" montre que la relation va dans les deux sens. Dans un groupe informel, quelqu'un peut dire : "On se tutoie ?" Cela propose de passer à « tu ». Mais cette proposition dépend de la situation. Entre deux collègues proches, entre amis, ou dans une activité détendue, « tu » peut sembler naturel. Dans un contexte de service, avec une personne inconnue, « vous » peut rester plus sûr.
