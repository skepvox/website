...
Esta página acompaña el episodio 001 de Vox Español, una serie SkepVox para aprender español. Reúne la guía de aprendizaje, el diálogo y la transcripción completa.
...
`Esté` es la forma de imperativo para `usted`; con `tú`, una opción natural sería `quédate aquí`. Ese detalle mantiene la cortesía formal de la escena, incluso cuando Marta está dando órdenes muy rápidas.
