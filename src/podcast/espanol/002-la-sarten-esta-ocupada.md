...
La palabra que resume todo es «ocupada». Una persona puede estar ocupada si no tiene tiempo; una silla puede estar ocupada si alguien la usa; una sartén puede estar ocupada si otra función la retiene. La sartén sigue siendo de Oscar y de hierro. Su identidad y su dueño no cambian. Lo que cambia es su situación: está sobre una mesa, debajo de una tortilla, sirviendo como pedestal y atrapada en el fallo del concurso. Eso explica el título: no se trata de una sartén cansada, sino de una sartén retenida por una función. Esa distinción ayuda: una identidad puede permanecer estable mientras la circunstancia se mueve a toda velocidad. La escena vuelve a preguntas concretas: quién es Oscar, qué es la sartén, de quién es, dónde está, cómo está y qué función cumple ahora. La sartén no está libre porque está ocupada; cuando termine el concurso, volverá a estar libre para la cena. Si escucha esas preguntas en la historia, el contraste se vuelve una forma de ordenar el caos. Ahora escuchemos el diálogo, esta vez a velocidad natural.
...
- **La sartén**: utensilio de cocina con mango que sirve para freír o cocinar. Aquí usamos la forma habitual en España: la sartén. Ejemplo: Oscar busca una sartén negra.
...
- **El mango**: parte alargada por donde se agarra una sartén, una taza o una herramienta. La palabra mango también nombra una fruta tropical; en esta escena se refiere siempre a la parte de la sartén. Ejemplo: La sartén tiene un mango rojo.
...
- **Listo, lista**: preparado para una acción. Una tortilla está lista cuando puede presentarse o servirse. Una persona puede ser lista cuando es inteligente y estar lista cuando ya puede salir o empezar. Ejemplos: Las tortillas están listas antes del concurso. Mi hermana es muy lista con los números.

- **Frío, fría**: con temperatura baja o sin el calor esperado. Aplicado a personas, una persona puede ser fría si tiene un carácter distante, o estar fría si tiene frío en ese momento. Ejemplos: La tortilla está un poco fría. Es una persona fría: saluda poco y se va rápido.
...
- **El fallo**: decisión final de un jurado. También puede significar error o avería, pero aquí se refiere al resultado del concurso. Ejemplo: El jurado da el fallo después de mirar la presentación.
