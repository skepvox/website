---
title: 'Central Única dos Trabalhadores (CUT)'
description: 'Resumo factual e fontes públicas sobre a Central Única dos Trabalhadores (CUT).'
demos:
  id: org--central-unica-dos-trabalhadores-cut
  type: org
  mapLabel: CUT
  seed: no
  ...
  identifiers:
    wikidata: Q365154
    wikipedia: https://pt.wikipedia.org/wiki/Central_%C3%9Anica_dos_Trabalhadores
  aliases:
    - CUT
...
- Sede (cidade, segundo Wikidata): Brasil — São Paulo — São Paulo. Fonte: [Wikidata (Q365154)](https://www.wikidata.org/wiki/Q365154).
...
Central sindical brasileira cuja fundação é citada em biografias e registros públicos.
...
- Wikipédia — “Central Única dos Trabalhadores” (acesso em 2026-01-09): https://pt.wikipedia.org/wiki/Central_%C3%9Anica_dos_Trabalhadores
