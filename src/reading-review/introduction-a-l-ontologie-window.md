---
title: 'Pipeline reading-flow preview — Introdução à ontologia'
buffer: true
search: false
head:
...
# Pipeline reading-flow preview — *Introdução à ontologia*

Internal, **non-public** reading-flow preview (a buffer page: noindexed, unlisted, out of the sitemap,
local search, and LLM output). It renders a small contiguous **window** of `pt` segments
